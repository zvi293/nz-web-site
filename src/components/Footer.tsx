...
const middleWavePaths: WavePathFrames = [
...
const frontMiddleWavePaths: WavePathFrames = [
...
const Footer = () => {
  ...
  const middleWave = createWaveAnimation(middleWavePaths);
  const frontMiddleWave = createWaveAnimation(frontMiddleWavePaths);
      ...
      <div className="relative h-28 md:h-40 bg-background">
        <svg
          ...
          <motion.path
            ...
            fillOpacity="0.5"
            initial={middleWave.initial}
            animate={middleWave.animate}
            transition={{
              duration: 6,
              ease: "easeInOut",
              repeat: Infinity
          ...
          <motion.path
            ...
            fillOpacity="0.7"
            initial={frontMiddleWave.initial}
            animate={frontMiddleWave.animate}
            transition={{
              duration: 4.5,
              ease: "easeInOut",
              repeat: Infinity
