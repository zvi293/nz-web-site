...
const smart: PricingPlan = {
  ...
  name: "סמארט",
  nickname: "״נוכחות״",
  tagline: "הצעד הראשון מ״אין לי אתר״ ל״יש לי נוכחות מקצועית בגוגל״, מהר ובלי סיכון.",
  setup: "2,500 ₪",
  ...
  details: {
    intro:
      "הצעד הראשון מ״אין לי אתר״ ל״יש לי נוכחות מקצועית בגוגל״. אתר מהיר, מאובטח ותקין, שמוכן לעבוד בלי שתצטרכו ללמוד או לתחזק דבר.",
    audience:
...
export const PACKAGES_PAGE = {
  ...
  seoDescription:
    "כל הפרטים על חבילות אתר התדמית של NZ-web: סמארט מ-2,500 ₪ הקמה ו-199 ₪ לחודש, פרו עם פאנל ניהול ובלוג, ועילית עם קידום במנועי AI. מה בדיוק כלול בכל חבילה, בלי עלויות נסתרות.",
