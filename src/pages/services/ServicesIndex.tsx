...
const ServicesIndex = () => {
  ...
  useSeoMeta({
    ...
    description: "כל שירותי בניית האתרים ופיתוח האתרים של NZ-web. בניית אתר תדמית, פיתוח אתרים, מערכת ניהול תורים, דפי נחיתה ובניית אתר מכירות לעסקים בישראל.",
    keywords: "שירותי בניית אתרים, שירותי פיתוח אתרים, בניית אתר תדמית, מערכת ניהול תורים, דפי נחיתה, בניית אתר מכירות, פתרונות דיגיטליים לעסקים",
  });
